...
<div className='flex justify-between mx-5 items-center'>
    ...
    <div>
        <button className='border border-blue-800 font-bold px-3 py-2 rounded-md text-blue-800 text-sm shadow-none hover:text-white hover:bg-blue-700 hover:shadow-blue-700 transition duration-200'>Transfer Ownership</button>
    </div>
...
<div className='flex justify-between mx-5 items-center'>
    ...
    <div>
        <button className=' text-sm border border-blue-800 font-bold px-3 py-2 rounded-md text-blue-800 shadow-none hover:text-white hover:bg-blue-700 hover:shadow-blue-700 transition duration-200'>Deactivate</button>
    </div>
...
<div className='flex justify-between mx-5 items-center'>
    ...
    <div className=''>
        <button className=' text-sm border border-red-600 font-semibold px-3 py-2 rounded-md text-red-600 shadow-none hover:text-white hover:bg-red-600 transition duration-200 '>Delete</button>
    </div>
